...
test('public ESM API exports SnowfallCanvas and defaultConfig', async () => {
  const mod = await import('../dist/index.js');

  assert.equal(typeof mod.SnowfallCanvas, 'function');
  assert.equal(typeof mod.defaultConfig, 'object');
});
